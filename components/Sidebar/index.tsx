    ...
    >
      ...
      />
          ...
          >
            ...
            <br />I am software engineer that specializes at front-end development, backend apis, interested in competitive coding too.
          </MotionText>
          <MotionButton
            size="lg"
            variant="outline"
            ...
            as={'a'}
            href="https://drive.google.com/file/d/1P2rkVlwafvovHgGz0JvdS4pLVELz0fxG/view"
            target="_blank"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
          >
